...
func parseFilter(qp queryParams) (restaurantbus.QueryFilter, error) {
	var fieldErrors errs.FieldErrors
	var filter restaurantbus.QueryFilter
	...
	if fieldErrors != nil {
		return restaurantbus.QueryFilter{}, fieldErrors.ToError()
	}
