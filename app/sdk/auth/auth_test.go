...
func Test_Auth(t *testing.T) {
	...
	t.Run("authorize different userID", test3(ath))
	t.Run("authorize different userID with RuleAny with ADMIN and USER token", test4(ath))
	t.Run("authorize different userID with RuleAny with USER token", test5(ath))
	t.Run("authorize different userID with RuleAny with ADMIN token", test6(ath))
}
